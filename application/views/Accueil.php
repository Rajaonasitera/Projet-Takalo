...
<body>
    <!-- Search Wrapper Area Start -->
        ...
        <div class="products-catagories-area clearfix">
            ...
            <h2 style="text-align:center; font-family:arial; margin-top:10px; margin-bottom:10px;">Other's object : </h2>
            <div class="amado-pro-catagory clearfix">
            <?php for ($i=0; $i < count($produit) ; $i++) { 
                $img=$this->frontoffice_model->getImage($produit[$i]['idProduit']);
            ?>
                <!-- Single Catagory -->
                <div class="single-products-catagory clearfix">
                    <a href="<?php echo base_url("Produit_controller/index/".$produit[$i]['idProduit']."/".$user);?>">
                    ...
                    <a href="<?php echo base_url("Echange_controller/index/".$user."/".$produit[$i]['idProduit']);?>" style="text-decoration:none; text-align:center;">Atakalo</a>
                </div>
